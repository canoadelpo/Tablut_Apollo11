...
public class TablutApollo11Client extends TablutClient {	

	    private boolean debug;

	    public TablutApollo11Client(String player, String name, int timeout, String ipAddress, int game, boolean debug) throws UnknownHostException, IOException {
	    ...
	    public static void main(String[] args) throws IOException {
	        ...
	        TablutApollo11Client client = new TablutApollo11Client(role, name, timeout, ipAddress, gameType, debug);
	        client.run();
	    }
